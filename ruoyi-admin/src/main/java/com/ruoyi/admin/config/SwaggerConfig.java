...
public class SwaggerConfig
{
    ...
    public Docket createRestApi()
    {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                // 指定当前包路径
                // .apis(RequestHandlerSelectors.basePackage("com.ruoyi.admin.controller.tool"))
                // .apis(basePackage("com.ruoyi.admin.controller.system,com.ruoyi.admin.controller.tool"))
